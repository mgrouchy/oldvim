...
hi Directory  guifg=#a92c8b guibg=NONE gui=NONE
...
hi rubySymbol  guifg=#a92c8b guibg=NONE gui=NONE
...
"hi pythonFunction
"hi pythonRepeat
hi pythonConditional  guifg=#445588 guibg=NONE gui=bold

"hi pythonPreCondit xxx links to Statement
"hi pythonException xxx links to Exception
"hi pythonOperator xxx links to Operator
"hi pythonDottedName xxx links to Function
"hi pythonDecorator xxx links to Define
"hi pythonDot      xxx links to Normal
"hi pythonTodo  guifg=#999988 guibg=NONE gui=inverse,bold,italic
"ho pythonComment  xxx links to Comment
